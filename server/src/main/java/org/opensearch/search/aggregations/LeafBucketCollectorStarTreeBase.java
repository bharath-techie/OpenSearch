 ...
 * @opensearch.internal
 */
public class LeafBucketCollectorStarTreeBase extends LeafBucketStarTreeCollector {
     ...
     */
    public LeafBucketCollectorStarTreeBase(LeafBucketCollector sub, Object values) {
        this.sub = sub;
    ...
    @Override
    public void collectStarEntry(int starEntry, long bucket) throws IOException {
        sub.collect(starEntry, bucket);
    }
}
