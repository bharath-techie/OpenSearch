 ...
 */
public class ValueAggregatorFactory1 {
    private ValueAggregatorFactory1() {}
     ...
     */
    public static ValueAggregator1 getValueAggregator(MetricStat aggregationType) {
        switch (aggregationType) {
            // avg aggregator will be covered in the part of query (using count and sum)
            case SUM:
                return new SumValueAggregator1();
            case COUNT:
                return new CountValueAggregator1();
            default:
    ...
    public static StarTreeNumericType getAggregatedValueType(MetricStat aggregationType) {
        switch (aggregationType) {
            ...
            case SUM:
                return SumValueAggregator1.VALUE_AGGREGATOR_TYPE;
            case COUNT:
                return CountValueAggregator1.VALUE_AGGREGATOR_TYPE;
            case MIN:
