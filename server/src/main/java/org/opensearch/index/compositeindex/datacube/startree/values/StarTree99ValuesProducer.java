...
/**
 *  Copy of Lucene90DocValuesProducer
 */
@ExperimentalApi
public final class StarTree99ValuesProducer extends StarTreeValuesProducer {
    ...
    public StarTree99ValuesProducer(SegmentReadState state, String dataCodec, String dataExtension, String metaCodec, String metaExtension)
        throws IOException {
    ...
    // Used for cloning
    private StarTree99ValuesProducer(
    ...
    public StarTree99ValuesProducer getMergeInstance() {
        return new StarTree99ValuesProducer(sortedNumerics, data, maxDoc, version, true);
    }
    ...
    private abstract static class DenseNumericDocValues extends StarTreeNumericValues {
    ...
    private abstract static class SparseNumericDocValues extends StarTreeNumericValues {
    ...
    private StarTreeNumericValues getNumeric(NumericEntry entry) throws IOException {
        if (entry.docsWithFieldOffset == -2) {
            // empty
            return StarTreeDocValues.emptyNumeric();
    ...
    private StarTreeSortedNumericValues getSortedNumeric(SortedNumericEntry entry) throws IOException {
        if (entry.numValues == entry.numDocsWithField) {
            return StarTreeDocValues.singleton(getNumeric(entry));
        }
