 ...
 */
public class MetricAggregatorInfo1 implements Comparable<MetricAggregatorInfo1> {
    ...
    private final ValueAggregator1 valueAggregators;
    private final StarTreeNumericType starTreeNumericType;

    /**
     * Constructor for MetricAggregatorInfo
     */
    public MetricAggregatorInfo1(MetricStat metricStat, String field, String starFieldName, IndexNumericFieldData.NumericType numericType) {
        this.metricStat = metricStat;
        this.valueAggregators = ValueAggregatorFactory1.getValueAggregator(metricStat);
     ...
     */
    public ValueAggregator1 getValueAggregators() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MetricAggregatorInfo1) {
            MetricAggregatorInfo1 anotherPair = (MetricAggregatorInfo1) obj;
    ...
    @Override
    public int compareTo(MetricAggregatorInfo1 other) {
        return Comparator.comparing((MetricAggregatorInfo1 o) -> o.field)
            .thenComparing((MetricAggregatorInfo1 o) -> o.metricStat)
            .compare(this, other);
    }
}
