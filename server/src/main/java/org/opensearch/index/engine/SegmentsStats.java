...
public class SegmentsStats implements Writeable, ToXContentFragment {
    ...
    private static final Map<String, String> FILE_DESCRIPTIONS = Map.ofEntries(
        ...
        Map.entry(Composite99DocValuesFormat.DATA_EXTENSION, "Composite Index Data"),
        Map.entry(Composite99DocValuesFormat.META_EXTENSION, "Composite Index Meta"),
        Map.entry(Composite99DocValuesFormat.DATA_DOC_VALUES_EXTENSION, "Composite Index DocValues Data"),
        Map.entry(Composite99DocValuesFormat.META_DOC_VALUES_EXTENSION, "Composite index DocValues Meta")
    );
