...
public class Lucene90DocValuesProducerCopy extends DocValuesProducer {
    ...
    public DocValuesProducer getMergeInstance() {
        return new Lucene90DocValuesProducerCopy(numerics, binaries, sorted, sortedSets, sortedNumerics, data, maxDoc, version, true);
    }
    ...
    private void readFields(IndexInput meta, FieldInfo[] infos) throws IOException {
        for (int fieldNumber = meta.readInt(); fieldNumber != -1; fieldNumber = meta.readInt()) {
            ...
            } else if (type == 3) { // Lucene90DocValuesFormat.SORTED_NUMERIC
  ...
  public SortedSetDocValues getSortedSet(String name) throws IOException {
    SortedSetEntry entry = sortedSets.get(name);
