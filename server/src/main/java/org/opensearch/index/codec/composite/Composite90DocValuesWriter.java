...
public class Composite90DocValuesWriter extends DocValuesConsumer {
    ...
    public Composite90DocValuesWriter(DocValuesConsumer delegate, SegmentWriteState segmentWriteState, MapperService mapperService)
        ...
        try {
            this.composite99DocValuesConsumer = new Composite99DocValuesConsumer(segmentWriteState, Composite90DocValuesFormat.DATA_DOC_VALUES_CODEC,
                Composite90DocValuesFormat.DATA_DOC_VALUES_EXTENSION, Composite90DocValuesFormat.META_DOC_VALUES_CODEC,
