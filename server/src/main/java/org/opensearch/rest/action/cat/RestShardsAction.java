...
public class RestShardsAction extends AbstractCatAction {
    ...
    protected Table getTableWithHeader(final RestRequest request) {
        ...
        table.addCell(
            ...
            "alias:spc,searchPointInTimeCurrent;default:false;text-align:right;desc:open pit contexts"
        );
        table.addCell(
            "search.point_in_time_time",
            "alias:spti,searchPointInTimeTime;default:false;text-align:right;desc:time pit contexts held open"
        );
        table.addCell(
            "search.point_in_time_total",
            "alias:spto,searchPointInTimeTotal;default:false;text-align:right;desc:completed pit contexts"
        );
