...
public class NodePerformanceTracker extends AbstractLifecycleComponent {
    ...
    public NodePerformanceTracker(PerformanceCollectorService performanceCollectorService, ThreadPool threadPool,
    ...
    void doRun() {
        ...
        performanceCollectorService.addNodePerfStatistics(LOCAL_NODE, getCpuPercentUsed(), getIoPercentUsed(),
            getMemoryPercentUsed(), System.currentTimeMillis());
    }
