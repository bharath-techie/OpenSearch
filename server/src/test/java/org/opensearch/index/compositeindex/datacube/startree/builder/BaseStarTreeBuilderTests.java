...
// StarTreeDocumentModified starTreeDocument1 = new StarTreeDocumentModified(new Long[] { 1L, 3L, 5L, 8L }, new Double[] { 4.0, 8.0 });
// StarTreeDocumentModified starTreeDocument2 = new StarTreeDocumentModified(new Long[] { 1L, 3L, 5L, 8L }, new Double[] { 10.0, 6.0 });
//
// StarTreeDocumentModified
// expectedeMergedStarTreeDocument = new StarTreeDocumentModified(new Long[] { 1L, 3L, 5L, 8L }, new Double[] { 14.0, 14.0 });
// StarTreeDocumentModified mergedStarTreeDocument = builder.reduceStarTreeDocuments(null, starTreeDocument1);
// StarTreeDocumentModified
// resultStarTreeDocument = builder.reduceStarTreeDocuments(mergedStarTreeDocument, starTreeDocument2);
//
