...
public enum InstructionType {
    ...
    /** Planner fast-path hints — carries a {@link FastPathHintSpec} the data node stamps onto the
     *  shard-scan execution context (mirrors {@link #SETUP_PARTIAL_AGGREGATE}). */
    FAST_PATH_HINTS;
    ...
    public InstructionNode readNode(StreamInput in) throws IOException {
        return switch (this) {
            ...
            case FAST_PATH_HINTS -> new FastPathHintsInstructionNode(in);
        };
    }
}
