...
public class CapabilityRegistry {
     ...
     * ignoring doc-value formats. Used by the term-equivalence gate in the filter rule: for a field
     * whose columnar equality is not semantically identical to the index term query
