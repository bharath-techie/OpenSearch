...
public class CacheStatsTests extends OpenSearchTestCase {
    ...
    public void testCacheStatsToXContentShape() throws IOException {
        CacheStats c = new CacheStats(
            ...
            new CacheGroupStats(0, 0, 0, 0, 64_000_000)
        );
        XContentBuilder builder = XContentFactory.jsonBuilder();
        builder.startObject();
    ...
    public void testCacheStatsEqualsAndHashCode() {
        CacheStats a = new CacheStats(new CacheGroupStats(1, 2, 3, 4, 5), new CacheGroupStats(6, 7, 8, 9, 10), new CacheGroupStats(11, 12, 13, 14, 15));
        CacheStats b = new CacheStats(new CacheGroupStats(1, 2, 3, 4, 5), new CacheGroupStats(6, 7, 8, 9, 10), new CacheGroupStats(11, 12, 13, 14, 15));
        CacheStats c = new CacheStats(new CacheGroupStats(1, 2, 3, 4, 5), new CacheGroupStats(6, 7, 8, 9, 10), new CacheGroupStats(11, 12, 13, 14, 99));
