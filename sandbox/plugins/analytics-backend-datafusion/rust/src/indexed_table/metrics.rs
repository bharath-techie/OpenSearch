...
impl PartitionMetrics {
    pub fn new(metrics: &ExecutionPlanMetricsSet, partition: usize) -> Self {
        ...
        Self {
            ...
            coalesce_time: MetricBuilder::new(metrics)
                .subset_time("coalesce_time", partition),
            batches_pre_coalesce: counter("batches_pre_coalesce"),
            build_mask_time: MetricBuilder::new(metrics)
                .subset_time("build_mask_time", partition),
            ...
            mask_slice_time: MetricBuilder::new(metrics)
                .subset_time("mask_slice_time", partition),
